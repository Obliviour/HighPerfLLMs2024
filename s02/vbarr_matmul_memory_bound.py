...
for data_type in D_TYPES:
    ...
    for matrix_dim in MATRIX_DIMS:
        ...
        with jax.named_scope(scope_name):
            a = jnp.ones((matrix_dim, matrix_dim), dtype=data_type)
            b = jnp.ones((matrix_dim, matrix_dim), dtype=data_type)
            ...
            mxu_bytes_per_op = 2
            compute_flops = matrix_dim**3 * a.itemsize * 2 / mxu_bytes_per_op
